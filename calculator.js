...
if ($('div#calculator-1').length) {
  ...
  const Calculate = () => {
    ...
    price.innerHTML = `+ $${numberWithCommas(finalPrice1)}<span> / month</span>`;
...
if ($('div#calculator-2').length) {
  ...
  const Calculate = () => {
    ...
    price.innerHTML = `+ $${numberWithCommas(finalPrice2)}<span> / month</span>`;
...
if ($('div#calculator-3').length) {
  ...
  const Calculate = () => {
    ...
    tooltip.innerHTML = `<span>${numberWithCommas(customers)} Messages</span>`;
    price.innerHTML = `+ $${numberWithCommas(finalPrice3)}<span> / month</span>`;
